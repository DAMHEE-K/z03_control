...
public class BranchExample {
	...
	public void ex5() {
		...
		for(int i = 1; i <= 10; i++) {
			if(i % 3 ==0) { // i가 3의 배수인 경우 다음 반복으로 넘어감
				continue;
			}
	...
	public void RPSGame() {
		...
		for(int i=1; i<=round; i++) {
			...
			String input = sc.next(); // 플레이어가 가위/바위/보를 입력한다.
